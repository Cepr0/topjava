...
public class MealTestData {
    ...
    public static final ModelMatcher<MealWithExceed> MATCHER_EX = new ModelMatcher<>(MealWithExceed.class);
    ...
    public static final MealWithExceed MEAL_EX1 = MealsUtil.createWithExceed(MEAL1, false);
    public static final MealWithExceed MEAL_EX2 = MealsUtil.createWithExceed(MEAL2, false);
    public static final MealWithExceed MEAL_EX3 = MealsUtil.createWithExceed(MEAL3, false);
    public static final MealWithExceed MEAL_EX4 = MealsUtil.createWithExceed(MEAL4, true);
    public static final MealWithExceed MEAL_EX5 = MealsUtil.createWithExceed(MEAL5, true);
    public static final MealWithExceed MEAL_EX6 = MealsUtil.createWithExceed(MEAL6, true);

    public static final List<Meal> MEALS = Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);
    public static final List<MealWithExceed> MEALS_EX = Arrays.asList(MEAL_EX6, MEAL_EX5, MEAL_EX4, MEAL_EX3, MEAL_EX2, MEAL_EX1);
